    ...
    \part{積分$\int$}
        ...
        \section{不定積分}
            ...
            \subsection{置換積分法}
                ...
                式\eqref{eq:置換積分}の$g'(x)$は$\frac{dt}{dx}$のことであるため、書き直すと
                \begin{equation}
        ...
        \section{定積分}
            ...
            \subsection{定積分の性質}
                ...
                性質\eqref{eq:定積分の加法性}から性質\eqref{eq:関数と積分値の大小関係}と性質\eqref{eq:int[a,a]=0}は容易に証明できるので演習問題とする。よって\eqref{eq:積分の平均値の定理}とを示す。
